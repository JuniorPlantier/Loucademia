package br.com.plantier.loucademia.domain.aluno;
...
public class AlunoRepository {
	...
	public List<Aluno> listSituacaoAluno(Situacao situacao) {
	...
	public List<Acesso> listAcessosAlunos(String matricula, LocalDate dataInicial, LocalDate dataFinal) {
		...
		if(dataInicial != null) {
			jpql.append("a.entrada >= :dataInicial AND ");
		}
		...
		if(dataInicial != null) {
			...
			q.setParameter("dataInicial", ldt);
		}
